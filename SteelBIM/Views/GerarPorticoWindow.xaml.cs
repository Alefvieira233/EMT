    ...
    public partial class GerarPorticoWindow : Window
    {
        ...
        public GerarPorticoConfig? BuildConfig()
        {
            ...
            return new GerarPorticoConfig
            {
                ...
                InserirChapaTopoPilar = chkChapaTopo.IsChecked == true,
                ChapaTopoEspessuraMm = NumberParsing.ParseDoubleOrDefault(txtChapaEsp.Text, 9.5),
                ChapaTopoLarguraMm = NumberParsing.ParseDoubleOrDefault(txtChapaLarg.Text, 200.0),
                ChapaTopoComprimentoMm = NumberParsing.ParseDoubleOrDefault(txtChapaComp.Text, 200.0),
